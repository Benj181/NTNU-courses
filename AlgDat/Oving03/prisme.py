...
# NB: Om denne verdien settes hÃ¸yt (>30) kan testene ta veldig lang tid.
n_upper = 25
        ...
        for bottom in range(top, n):
            ...
            for i, h in enumerate(extended):
                while stack and extended[stack[-1]] > h:
                    ...
                    width = i - left - 1
                    radspan = bottom - top + 1
                    vol = height * width * radspan
                    if vol > best:
                        best = vol
                stack.append(i)
...
# Treg bruteforce lÃ¸sning for Ã¥ finne lÃ¸snings for tilfeldig genererte tester.
